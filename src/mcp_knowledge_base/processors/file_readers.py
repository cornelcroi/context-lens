...
class FileProcessingError(KnowledgeBaseError):
    ...
    def __init__(self, message: str, error_type: str = "processing_error", details: Optional[dict] = None):
...
class FileReader(ABC):
            ...
            if confidence < 0.7:
                ...
                for fallback_encoding in ['utf-8', 'utf-16', 'latin-1', 'cp1252']:
                    try:
                        ...
                        logger.debug(f"Successfully validated fallback encoding: {fallback_encoding}")
    ...
    def read_file_content(self, file_path: str) -> str:
        ...
        try:
            ...
            logger.warning(f"Unicode decode error with {encoding}, trying with error replacement: {e}")
