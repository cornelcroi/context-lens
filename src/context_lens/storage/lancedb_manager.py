...
class VectorSearchResult:
    ...
    def __init__(self, document_id: str, chunk_id: str, content: str, 
...
class LanceDBManager:
    ...
    async def add_document_vectors(self, document_metadata: DocumentMetadata, 
    ...
    async def search_vectors(self, query_vector: List[float], limit: int = 10) -> List[VectorSearchResult]:
    ...
    async def list_all_documents(self, limit: Optional[int] = None, 
                               offset: int = 0) -> List[DocumentMetadata]:
