...
class TestEndToEndWorkflow:
    ...
    @pytest.mark.asyncio
    async def test_complete_document_ingestion_workflow(self, integration_config, sample_documents, temp_dir):
        ...
        try:
            ...
            for doc_name, doc_path in sample_documents.items():
                ...
                assert result["success"] is True, f"Failed to add {doc_name}: {result.get('error_message')}"
...
class TestSearchFunctionality:
    ...
    @pytest.mark.asyncio
    async def test_search_with_relevant_results(self, integration_config, sample_documents, temp_dir):
        ...
        try:
            ...
            found_binary_search = any(
                "binary" in r["content_excerpt"].lower() 
