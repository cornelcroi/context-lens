...
class TestConfig:
    ...
    def test_from_env_defaults(self):
        ...
        env_vars = [
            "LANCE_DB_PATH", "LANCE_DB_TABLE_PREFIX",
            "EMBEDDING_MODEL", "EMBEDDING_BATCH_SIZE", "EMBEDDING_CACHE_DIR",
            "MAX_FILE_SIZE_MB", "CHUNK_SIZE", "CHUNK_OVERLAP", "SUPPORTED_EXTENSIONS",
